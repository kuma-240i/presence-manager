function exec() {
    ...
    fetch(url).then(res =>{
        ...
        const offi = data.filter((person) => {
            ...
            if (cur.message === null){
                return acc + cur.name + "　　" + cur.presence + "　投稿時間：" + cur.update_time.slice(0, 4) + "/" + cur.update_time.slice(5, 7) + "/" + cur.update_time.slice(8, 10) + " " + cur.update_time.slice(11, 13) + ":" + cur.update_time.slice(14, 16) + "<br>";
            }else{
                return acc + cur.name + "　　" + cur.presence + "　投稿時間：" + cur.update_time.slice(0, 4) + "/" + cur.update_time.slice(5, 7) + "/" + cur.update_time.slice(8, 10) + " " + cur.update_time.slice(11, 13) + ":" + cur.update_time.slice(14, 16) + " 「" + cur.message + "」<br>";
            }
        },'');
